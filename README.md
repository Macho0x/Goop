...
**[v1.19.0](https://github.com/Macho0x/Goop/releases/tag/v1.19.0)** — multi-file modules + record `@[tag]`. **[Playground](https://macho0x.github.io/Goop/)** is the fastest way to try Goop.
