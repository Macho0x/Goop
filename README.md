...
**[v1.20.0](https://github.com/Macho0x/Goop/releases/tag/v1.20.0)** — `@[go]` import hoist + multi-file import merge. **[Playground](https://macho0x.github.io/Goop/)** is the fastest way to try Goop.
