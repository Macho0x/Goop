...
| [2. Types and patterns](02-types-and-patterns.md) | ADTs, `match`, lists, records, branded IDs | [`shapes.goop`](../examples/shapes.goop), [`list_combinators.goop`](../examples/list_combinators.goop), [`point_distance.goop`](../examples/point_distance.goop) |
...
| [6. Safety checks](06-safety-checks.md) | Exhaustiveness, branding, refinements, Go idioms | [`branded_ids.goop`](../examples/branded_ids.goop), [`trading_order.goop`](../examples/trading_order.goop) |
