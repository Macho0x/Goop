...
func tipForMessage(rest string) string {
	...
	ordered := []string{
		...
		"UNUSED002", "UNUSED001", "OPTION001", "RESULT001", "DEADLOCK001", "NIL001",
		"VIS002", "VIS001", "IMPORT003", "IMPORT002", "IMPORT001", "TYPE011",
		"CODEGEN003", "CODEGEN002", "CODEGEN001", "GOSIG002", "GOSIG001",
